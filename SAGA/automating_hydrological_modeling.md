This is the Batch Script to mosaic and project the ASTER num file:
```
...
saga_cmd grid_tools 3 -GRIDS=ASTGTMV003_S04E037_num2.sgrd;ASTGTMV003_S04E037_num2.sgrd; -NAME=%pre%Mosaic -TYPE=9 -RESAMPLING=0 -OVERLAP=1 -MATCH=0 -TARGET_OUT_GRID=%od%\%pre%mosaic2.sgrd

:: Run UTM Projection tool
saga_cmd pj_proj4 24 -SOURCE=%od%\%pre%mosaic2.sgrd -RESAMPLING=0 -KEEP_TYPE=1 -GRID=%od%\%pre%mosaicUTM2.sgrd -UTM_ZONE=37 -UTM_SOUTH=1
...
PAUSE
```
This is the Batch Script to run the hydrological analysis for the ASTR DEM file:
```
::set the path to your SAGA program
SET PATH=%PATH%;c:\saga6
...
This is the Batch Script to mosaic and project the SRTM num file:
```
::set the path to your SAGA program
SET PATH=%PATH%;c:\saga6
...
:: Run Mosaicking tool, with consideration for the input -GRIDS, the -
saga_cmd grid_tools 3 -GRIDS=S04E037.sgrd;S03E037.sgrd; -NAME=%pre%Mosaic -TYPE=9 -RESAMPLING=0 -OVERLAP=1 -MATCH=0 -TARGET_OUT_GRID=%od%\%pre%mosaic.sgrd
...
PAUSE
```
This is the Batch Script to run the hydrological analysis for the SRTM DEM file:
```
::set the path to your SAGA program
SET PATH=%PATH%;c:\saga6
